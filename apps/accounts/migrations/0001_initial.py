    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('about_yourself', models.TextField(blank=True, null=True, verbose_name='О себе')),
                ('birth_date', models.DateField(blank=True, null=True, verbose_name='День рождения')),
                ('is_agree', models.BooleanField(blank=True, default=False, null=True, verbose_name='Чекбокс согласие на условия')),
